...
- [SNEAK: Snarkles.Net Encryption Assortment Kit](http://www.snarkles.net/scripts/sneak/sneak.php)
- [String decoder & encoder](https://encoder.mattiasgeniar.be/)
- [IP Address Converter](https://www.psyon.org/tools/ip_address_converter.php?ip=8.8.8.8)
...
- [memorpy - Python library using ctypes to search/edit windows/linux/OSX/SunOS programs memory](https://github.com/n1nj4sec/memorpy)
- [LinEnum - Scripted Local Linux Enumeration & Privilege Escalation Checks](https://github.com/rebootuser/LinEnum)
- [Windows-Exploit-Suggester](https://github.com/GDSSecurity/Windows-Exploit-Suggester)
- [SessionGopher - extract session info from WinSCP, PuTTY, SuperPuTTY, FileZilla, and RDP](https://github.com/fireeye/SessionGopher)
...
- [Shadow Broker](https://github.com/misterch0c/shadowbroker)

## Stealth

- [Cryptocat](https://crypto.cat/)
- [Panopticlick - browser tracking tests](https://panopticlick.eff.org/)
...
- [DumpsterFire Toolset - "Security Incidents In A Box!"](https://github.com/TryCatchHCF/DumpsterFire)
- [DNS Blacklists](https://bitbucket.org/ethanr/dns-blacklists)
...
- [firepwd - decrypt Mozilla protected passwords](https://github.com/lclevy/firepwd)
- [OWASP Skanda - SSRF Exploitation Framework](https://github.com/jayeshchauhan/SKANDA)
- [JS Beautifier](https://github.com/beautify-web/js-beautify)
- [httpscreenshot](https://github.com/breenmachine/httpscreenshot)
- [Aquatone - A Tool for Domain Flyovers](https://github.com/michenriksen/aquatone#installation)
...
- [WPSeku - Wordpress Security Scanner](https://github.com/m4ll0k/WPSeku)
- [RAWR - Rapid Assessment of Web Resources](https://bitbucket.org/al14s/rawr/wiki/Home)
- [Certificate Transparency Monitoring](https://developers.facebook.com/tools/ct/)
...
- [ILSpy - .NET Decompiler](https://github.com/icsharpcode/ILSpy#ilspy-------)
...
- [IP Address Locator](http://geobytes.com/iplocator/)
...
- [Kloth.net Online Tools and Services](http://www.kloth.net/services/)
...
- [TrustedSec tools](https://github.com/trustedsec)
- [fuzzbunch](https://github.com/fuzzbunch/fuzzbunch)
- [A Red Teamer's guide to pivoting](https://artkond.com/2017/03/23/pivoting-guide/)
- [byt3bl33d3r tools](https://github.com/byt3bl33d3r/)
- [dafthack tools](https://github.com/dafthack)
- [Ruler - A tool to abuse Exchange services](https://github.com/sensepost/ruler)
- [Impacket - collection of Python classes for working with network protocols](https://github.com/CoreSecurity/impacket)
- [GoFetch - automatically exercise an attack plan generated by BloodHound](https://github.com/GoFetchAD/GoFetch)
- [Responder](https://github.com/lgandx/Responder)
- [MDSec Research tools](https://github.com/mdsecresearch)
